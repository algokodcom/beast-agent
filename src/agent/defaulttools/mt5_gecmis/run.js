'use strict';
// MT5 KAPANMIS ISLEM GECMISI — stdin: JSON args · stdout: JSON sonuç
...
(async function main() {
  ...
  if (r.ok && r.data) return console.log(JSON.stringify({ ok: true, count: r.data.count, deals: r.data.deals }));
  console.log(JSON.stringify({ ok: false, error: r.error || 'gecmis alinamadi' }));
})();
