...
contextBridge.exposeInMainWorld('beast', {
  ...
  sandboxRunStop: () => ipcRenderer.invoke('sandbox:runstop'),
  ...
  headroomToggle: (on) => ipcRenderer.invoke('headroom:toggle', !!on),
  headroomStatus: () => ipcRenderer.invoke('headroom:status'),
  headroomStats: () => ipcRenderer.invoke('headroom:stats'),
